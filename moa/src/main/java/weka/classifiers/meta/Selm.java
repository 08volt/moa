...
public class Selm implements Serializable {
     ...
     *
     * @param elm_type
     *            - Determine whether it is a numerical prediction or a nominal classification
     * @param numberofHiddenNeurons
     *            - Number of hidden neurons
     * @param ActivationFunction
     *            - Two activation function
     * @param randomSeed
     *            - Random seed, for the algorithm to be reproducible
     * @param classIndex
     *            - Prediction or classification Attribute label, location
     */
    public Selm(int elm_type, int numberofHiddenNeurons,
        ...
        NumberofHiddenNeurons = numberofHiddenNeurons;
        func = ActivationFunction;
        NumberofOutputNeurons = 1; // The default is one, numeric output
    ...
    /**
     * If it is a nominal prediction, extract the number of predicted nouns, starting from 0, so +1
     *
     * @param traindata
     * @throws NotConvergedException
     */
    ...
    /**
     * Normalize data to double-precision two-dimensional array
     *
     * @param instances
     * @param nomalization
     * @throws NotConvergedException
    ...
    public void train(Instances instances, double[][] nomalization)
        ...
        /**
         * Numerical attribute normalization x-min/(max-min)
         */
    ...
    /**
     * Randomized matrix Because there is a random seed, the random number is controllable, and the algorithm result can be reproduced
     *
     * @param rows
     * @param columns
     * @param seed
    ...
    private static void train() throws NotConvergedException {
        ...
        /**
         * La matrice casuale è incontrollabile e il risultato non è riproducibile
